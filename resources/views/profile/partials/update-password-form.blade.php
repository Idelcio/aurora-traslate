<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('profile.password_instructions') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="font-normal">{{ __('profile.save') }}</x-primary-button>
            ...
            <p
                ...
                class="text-sm text-gray-600 font-normal">{{ __('profile.saved') }}</p>
            @endif
        </div>
    </form>
</section>