<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Company Name -->
        <div class="mt-4">
            <x-input-label for="company_name" :value="__('forms.company_name')" />
        ...
        <!-- Phone/WhatsApp -->
        <div class="mt-4">
            <x-input-label for="phone" :value="__('forms.phone')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('forms.password_confirmation')" />
