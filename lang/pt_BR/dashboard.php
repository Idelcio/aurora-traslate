...
return [
    ...
    'subscription' => [
        ...
        'pages_per_book' => 'Páginas/livro',
        'books_this_month' => 'Livros (30 dias)',
    ...
    'form' => [
        ...
        'auto_detect_hint' => 'O idioma de origem será detectado automaticamente',
        'start_page_label' => 'Página inicial (opcional)',
        'end_page_label' => 'Página final (opcional)',
        'start_page_placeholder' => 'Ex: 20',
        'end_page_placeholder' => 'Ex: 50',
        'page_range_helper' => 'Deixe vazio para traduzir todo o PDF. Ex: páginas 20-50 ou 10-100',
        ...
        'target_language_options' => [
            ...
            'de' => 'Alemão',
            'la' => 'Latim',
            // Grego e Hebraico removidos temporariamente (problema com fontes especiais no PDF de saída)
            // 'he' => 'Hebraico',
            // 'el' => 'Grego',
        ],
